...
describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    if (text != 'Remove from Cart') { correctTextValue = false; }

    expect(correctTextValue).toBe(true);
  }, 2500);
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for(let i = 0; i < prodItems.length; i++) {
      ...
      let buttonText = buttonTextProperty['_remoteObject'].value;

      if (buttonText != 'Remove from Cart') { correctButtonText = false; }
    }
  ...
  it('Checking number of items in cart on screen after removing from cart', async () => {
    ...
    let correctCartCountAfterRemove = true;
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for(let i = 0; i < prodItems.length; i++) {
      ...
      if (buttonText != 'Add to Cart') { correctButtonText = false; }
    }
